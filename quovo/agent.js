...
export function ensure__agent__quovo__users(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__users`);
  return ensure__agent__quovo__rpc(ctx, {
    key: "agent__quovo__users",
    scope: ["quovo__users"],
    rpc: ["get__quovo__users"]
  }, ...agent$ctx$$);
}
export function ensure__agent__quovo__user_id(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__user_id`);
  return ensure__agent(ctx, {
    key: "agent__quovo__user_id",
    scope: ["quovo__user_id"]
  }, ...agent$ctx$$);
}
export function ensure__agent__quovo__user(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__user`);
  let agent;
  ...
  function quovo__user_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__user|quovo__user_id__on$change`);
    set__agent();
  }
  function quovo__users__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__user|quovo__users__on$change`);
    set__agent();
  }
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__user|set__agent`);
...
export function ensure__agent__quovo__user__accounts(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__user__accounts`);
  let agent;
  ensure__agent__quovo__user_id(ctx);
  return ensure__agent__quovo__rpc(ctx, {
  ...
  function quovo__user_id__on$change() {
   log(`${logPrefix}|ensure__agent__quovo__user__accounts|quovo__user_id__on$change`);
   agent.co$reset();
  }
}
export function ensure__agent__quovo__account_id(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__account_id`);
  return ensure__agent(ctx, {
    key: "agent__quovo__account_id",
    scope: ["quovo__account_id"]
  }, ...agent$ctx$$);
}
export function ensure__agent__quovo__user__account(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__user__account`);
  let agent;
  ...
  function quovo__user__accounts__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__user__account|quovo__accounts__on$change`);
    set__agent__quovo__user__account();
  }
  function quovo__account_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__user__account|quovo__account_id__on$change`);
    set__agent__quovo__user__account();
  }
  function set__agent__quovo__user__account() {
    log(`${logPrefix}|ensure__agent__quovo__user__account|set__agent__quovo__user__account`);
...
export function ensure__agent__quovo__account__portfolios(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__account__portfolios`);
  let agent;
  ensure__agent__quovo__account_id(ctx);
  return ensure__agent__quovo__rpc(ctx, {
  ...
  function quovo__account_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__account__portfolios|quovo__account_id__on$change`);
    set__agent();
  }
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__account__portfolios|set__agent`);
    change__agents(ctx, {
...
export function ensure__agent__quovo__portfolio_id(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__portfolio_id`);
  return ensure__agent(ctx, {
    key: "agent__quovo__portfolio_id",
    scope: ["quovo__portfolio_id"]
  }, ...agent$ctx$$);
}
export function ensure__agent__quovo__portfolio(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__portfolio`);
  let agent;
  ...
  function quovo__account__portfolios__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio|quovo__account__portfolios__on$change`);
    set__agent__quovo__portfolio_id();
  }
  function quovo__portfolio_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio|quovo__portfolio_id__on$change`);
    set__agent__quovo__portfolio_id();
  }
  function set__agent__quovo__portfolio_id() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio|set__agent__quovo__portfolio_id`);
...
export function ensure__agent__quovo__portfolio__history(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__portfolio__history`);
  let agent;
  ensure__agent__quovo__portfolio_id(ctx);
  return ensure__agent__quovo__rpc(ctx, {
  ...
  function quovo__portfolio_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio__history|quovo__portfolio_id__on$change`);
    agent.co$reset();
  }
}
export function ensure__agent__quovo__positions(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__positions`);
  let agent;
  ensure__agent__quovo__account_id(ctx);
  return ensure__agent__quovo__rpc(ctx, {
  ...
  function set__agent__quovo__positions() {
    log(`${logPrefix}|ensure__agent__quovo__positions|quovo__account_id__on$change`);
    change__agents(ctx, {quovo__positions: null});
    agent.co$reset();
  }
}
export function ensure__agent__quovo__portfolio__positions(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__portfolio__positions`);
  let agent;
  ensure__agent__quovo__portfolio_id(ctx);
  ...
  function quovo__portfolio__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio__positions|quovo__portfolio__on$change`);
    set__agent__quovo__portfolio__positions();
  }
  function quovo__positions__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio__positions|quovo__positions__on$change`);
    set__agent__quovo__portfolio__positions();
  }
  function set__agent__quovo__portfolio__positions() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio__positions|set__agent__quovo__portfolio__positions`);
...
export function ensure__agent__quovo__iframe(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__iframe`);
  let agent;
  ensure__agent__quovo__user_id(ctx);
  return ensure__agent__quovo__rpc(ctx, {
  ...
  function quovo__user_id__on$change() {
    log(`${logPrefix}|ensure__agent__quovo__iframe|quovo__user_id__on$change`);
    set__agent();
  }
  function set__agent() {
...
export function ensure__agent__quovo__rpc(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|ensure__agent__quovo__rpc`);
  let agent;
  ...
  function init() {
    log(`${logPrefix}|ensure__agent__quovo__rpc|init`);
    agent = arguments[0];
  ...
  function new__rpc$ctx(reset$ctx, ...reset$ctx$rest$$) {
    log(`${logPrefix}|ensure__agent__quovo__rpc|new__rpc$ctx`);
