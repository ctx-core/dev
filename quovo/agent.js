...
export function ensure__agent__quovo__user__account(ctx, ...agent$ctx$$) {
  ...
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__user__account|set__agent`);
...
export function ensure__agent__quovo__portfolio(ctx, ...agent$ctx$$) {
  ...
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio|set__agent`);
...
export function ensure__agent__quovo__positions(ctx, ...agent$ctx$$) {
  ...
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__positions|set__agent`);
...
export function ensure__agent__quovo__portfolio__positions(ctx, ...agent$ctx$$) {
  ...
  function set__agent() {
    log(`${logPrefix}|ensure__agent__quovo__portfolio__positions|set__agent`);
...
export function ensure__agent__quovo__rpc(ctx, ...agent$ctx$$) {
  ...
  function new__rpc$ctx(reset$ctx, ...reset$ctx$rest$$) {
    log(`${logPrefix}|ensure__agent__quovo__rpc|new__rpc$ctx`, agent.key);
