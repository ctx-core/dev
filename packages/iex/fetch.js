...
export async function get__ref_data_symbols(opts = {}) {
    return (fetch__iex(_path__ref_data_symbols(), opts));
}
...
export async function get__ref_data_exchange_symbols(opts, params) {
    return (fetch__iex(_path__ref_data_exchange_symbols(params), opts));
}
...
export async function get__ref_data_exchanges(opts = {}) {
    return (fetch__iex(_path__ref_data_exchanges(), opts));
}
...
export function get__fx_rate({ from, to }, opts = {}) {
    return (fetch__iex(_path__fx_rate({ from, to }), opts));
}
...
export function get__marketcap({ ticker }, opts = {}) {
    return (fetch__iex(_path__marketcap({ ticker }), opts));
}
...
export function get__peRatio({ ticker }, opts = {}) {
    return (fetch__iex(_path__peRatio({ ticker }), opts));
}
...
export function get__ytdChangePercent({ ticker }, opts = {}) {
    return (fetch__iex(_path__ytdChangePercent({ ticker }), opts));
}
