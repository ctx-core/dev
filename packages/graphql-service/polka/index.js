...
function use__ApolloServer__polka(path, app, params__ApolloServer) {
    ...
    const server = new ApolloServer(object.assign({ uploads: false }, params__ApolloServer));
    server.applyMiddleware({ app, path });
    return app;
}

exports.graphql_upload__polka = graphql_upload__polka;
exports.use__ApolloServer__polka = use__ApolloServer__polka;
