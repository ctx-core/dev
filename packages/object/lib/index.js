 ...
 * @returns {obj}
 */
function defaults(obj, ...a1__defaults) {
 ...
 * @returns {obj} obj
 */
function assign__unless__null(obj) {
 ...
 *	})
 */
function mixin(target, ...a1__source) {
    if (!target)
        return;
 ...
 * @returns target
 */
function merge(target, ...a1__source) {
    if (!target)
        return;
 ...
 */
function ensure(obj, ...a1__ctx__rest) {
    if (!obj)
        return;
 ...
 * @param {...string} a1__key
 */
function pick__hasOwnProperty(obj, ...a1__key) {
    if (!obj)
        return;
    let memo = {};
    for (let i = 0; i < a1__key.length; i++) {
 ...
 * @param {*} obj__keys
 */
function pick__keys(obj, obj__keys) {
 ...
 * @param {*} obj__keys
 */
function unpick__keys(obj, obj__keys) {
 ...
 * @returns {*[]}
 */
function _a1__value__pick(obj, ...a1__key) {
    if (!obj)
        return;
    let a1__value = [];
    for (let i = 0; i < a1__key.length; i++) {
 ...
 */
function some(obj, some__compare) {
    if (!obj)
        return;
    for (let key in obj) {
        if (some__compare(obj[key], key))
            return true;
    }
    return false;
}
 ...
 */
function ensure__refresh(obj, ...a1__ctx__refresh) {
    if (!obj)
        return;
    const ctx__refresh = clone(...a1__ctx__refresh);
    const { key, ensure, refresh } = ctx__refresh;
    if (!obj[key]) {
        obj[key] = ensure(obj);
    }
    refresh(obj, obj[key]);
 ...
 */
function or__null(opts = {}) {
    const { value, value__or, value__nor } = opts;
 ...
 * @returns {boolean}
 */
function has__key(obj, key = symbol__no_key_arg) {
    if (key === symbol__no_key_arg) {
        ...
        for (let key__ in obj) {
            if (key.toString() == key__.toString())
                return true;
        }
    }
    return false;
 ...
 * @return {*}
 */
function _ctx__clear(a1__key, value__clear) {
    const ctx__clear = {};
    for (let i = 0; i < a1__key.length; i++) {
        const key = a1__key[i];
 ...
 * @returns {*}
 */
function _ctx__zip(a1__key, a1__value) {
    const ctx__zip = {};
    if (a1__key) {
        for (let i = 0; i < a1__key.length; i++) {
 ...
 * @returns {*}
 */
function set__false__if__null(obj, ...a1__key) {
    for (let i = 0; i < a1__key.length; i++) {
        const key = a1__key[i];
        if (obj[key] == null)
            obj[key] = false;
 ...
 * @returns {*}
 */
function map__obj__andand(obj, ...a1__key) {
    return map__obj(obj, _function._andand(...a1__key));
}
/**
 ...
 * @returns {function(*)}
 */
function _map__obj(fn) {
    return obj => map__obj(obj, fn);
}
const _fn__map__obj = _map__obj;
/**
 * Returns function to
 * map `values` `andand` `a1__key` in `obj` to `fn`, returning object with values return by `fn`.
 * @param {...string} a1__key
 * @returns {function(*)}
 */
function _map__obj__andand(...a1__key) {
    return obj => map__obj__andand(obj, ...a1__key);
}
const _fn__map__obj__andand = _map__obj__andand;
/**
 ...
 * @returns {*}
 */
function _hash__key__obj(obj, key) {
    const by__key__obj = {};
...
exports._a1__value__pick = _a1__value__pick;
exports._a2__key__value = _a2__key__value;
exports._ctx__clear = _ctx__clear;
exports._ctx__zip = _ctx__zip;
exports._fn__map__obj = _fn__map__obj;
exports._fn__map__obj__andand = _fn__map__obj__andand;
exports._has__key = _has__key;
exports._hash__key__obj = _hash__key__obj;
exports._is__Object = _is__Object;
exports._map__obj = _map__obj;
exports._map__obj__andand = _map__obj__andand;
exports._pick = _pick;
...
exports.ensure__refresh = ensure__refresh;
exports.exclude = exclude;
exports.has__key = has__key;
exports.has__some__key = has__some__key;
exports.isArray = isArray;
exports.isObject = isObject;
exports.keys = keys;
exports.map__obj = map__obj;
exports.map__obj__andand = map__obj__andand;
exports.merge = merge;
exports.mixin = mixin;
exports.or__null = or__null;
exports.pick = pick;
exports.pick__hasOwnProperty = pick__hasOwnProperty;
exports.pick__keys = pick__keys;
exports.set__false__if__null = set__false__if__null;
exports.some = some;
exports.toString = toString;
exports.unpick = unpick;
exports.unpick__keys = unpick__keys;
