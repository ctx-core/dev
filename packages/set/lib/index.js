...
function _union(nowrap__a2__member) {
    const a1__nowrap__a1__member = _function._a1__wrap(nowrap__a2__member);
    let a1__member__set = [];
    for (let i = 0; i < a1__nowrap__a1__member.length; i++) {
        const a1__member = _function._a1__wrap(a1__nowrap__a1__member[i]);
...
function _intersection(__a2__member) {
    const a1__nowrap__a1__member = _function._a1__wrap(__a2__member);
    const [__a1__root, ...a1__nowrap__a1__rest] = a1__nowrap__a1__member;
    const set__rest = _union(a1__nowrap__a1__rest);
    const a1__root = _function._a1__wrap(__a1__root);
    let a1__member__set = [];
...
exports._difference__set = _difference__set;
exports._intersection = _intersection;
exports._intersection__set = _intersection__set;
exports._union = _union;
exports._union__set = _union__set;
