...
export function fetch__a1__pathname__medium(opts = {}) {
    const { Bucket = process.env.S3_BUCKET, KEY__A1__PATHNAME__MEDIUM = process.env.KEY__A1__PATHNAME__MEDIUM, } = opts;
    return fetch(`https://s3.amazonaws.com/${Bucket}/${KEY__A1__PATHNAME__MEDIUM}`, { mode: 'cors' });
}
