 ...
 */
export declare const curry: (fn: any) => () => any;
export declare const flip: (fn: any) => () => any;
export declare const curry__flip: (fn: any) => () => any;
/**
 *
 * @param fn__append
 * @returns {function(*=): *}
 ...
 */
export declare function _fn__curry(fn__append: any): (fn: any) => () => any;
/**
 ...
 */
export declare const liftA2: () => any;
