...
function _a2__wrap(nowrap__a2) {
    return map(_function._a1__wrap(nowrap__a2), _function._a1__wrap);
}
/**
...
function _hash__key__a1(nowrap__a1__ctx) {
    const a1__ctx = _function._a1__wrap(nowrap__a1__ctx);
    const hash__key__a1 = {};
    for (let i = 0; i < a1__ctx.length; i++) {
        const ctx = a1__ctx[i];
        for (let key in ctx) {
            const value = ctx[key];
            hash__key__a1[key] = _function.concat(hash__key__a1[key] || [], value);
        }
    }
...
const concat__a1 = _function.concat;
/**
...
function concat__default__a1(a1, ...a1__rest) {
    let a1__ = a1 ? _function._a1__wrap(a1) : [];
...
function flatten(a1) {
    if (!a1)
        return;
    return a1.reduce((a, b) => _function.concat(a, object.isArray(b)
        ? flatten(b)
        : b), []);
}
/**
...
function _union(nowrap__a2) {
    ...
    return Array.from(set._union__set(a2));
}
...
function _intersection(nowrap__a2) {
    const a2 = _a2__wrap(nowrap__a2);
    return Array.from(set._intersection__set(a2));
}
...
function _difference(nowrap__a2) {
    const a2 = _a2__wrap(nowrap__a2);
    return Array.from(set._difference__set(a2));
}
 ...
 * @returns {Object}
 */
const _hash__item__idx = _fn__hash__item__idx(combinators.I__);
/**
 ...
 * @returns {Object}
 */
function _hash__key__idx(a1, key, _val = combinators.I__) {
    let hash__key__idx = {};
    if (a1) {
        for (let idx = 0; idx < a1.length; idx++) {
            const item = a1[idx];
...
function zip(nowrap__a2) {
    return zipWith(nowrap__a2, combinators.I);
}
/**
 ...
 */
function _fn__ctx__compact__a1__thold__entry(fn__eq = _function.eq) {
    return a1__val__ => {
        const a1__idx = [];
        const a1__val = [];
        if (a1__val__) {
 ...
 * @returns {function(Array): ctx__idx}
 */
function _fn__ctx__compact__a1__thold__exit(fn__eq = _function.eq) {
    return a1__val__ => {
        const a1__idx = [];
        const a1__val = [];
        if (a1__val__) {
 ...
 * @returns {Array|null}
 */
function filter__idx(a1, _is_match = combinators.I__) {
    if (!a1)
        return;
    const a1__idx = [];
    for (let idx = 0; idx < a1.length; idx++) {
 ...
 * @returns {function(Array):(Array|null)}
 */
function _filter__idx(_is_match = combinators.I__) {
...
function map__andand(a1, ...a1__attr) {
    return map(a1, _function._andand(...a1__attr));
}
/**
...
function map__andand_(a1, ...a1__attr) {
    return map(a1, _function._andand_(...a1__attr));
}
...
function map__andand__or(a1, a1__attr, fn__or) {
    return map(a1, _function._andand__or(a1__attr, fn__or));
}
/**
...
Object.defineProperty(exports, '_a1__wrap', {
	enumerable: true,
	get: function () {
		return _function._a1__wrap;
	}
});
Object.defineProperty(exports, 'concat', {
	enumerable: true,
	get: function () {
		return _function.concat;
	}
});
exports._a1__gte__0 = _a1__gte__0;
exports._a1__idx = _a1__idx;
exports._a1__idx__invert = _a1__idx__invert;
exports._a1__idx__sort = _a1__idx__sort;
exports._a1__lte__0 = _a1__lte__0;
exports._a1__sort = _a1__sort;
exports._a1__sort__idx = _a1__sort__idx;
exports._a1__sparse = _a1__sparse;
exports._a1__val__from__a1__key = _a1__val__from__a1__key;
exports._a1__val__sort = _a1__val__sort;
exports._a2__chunk = _a2__chunk;
exports._a2__destructure__offset = _a2__destructure__offset;
exports._a2__wrap = _a2__wrap;
exports._circular_idx = _circular_idx;
exports._compare = _compare;
exports._compare__key = _compare__key;
exports._ctx__compact__a1__sparse = _ctx__compact__a1__sparse;
exports._ctx__compact__a1__thold__entry = _ctx__compact__a1__thold__entry;
exports._ctx__compact__a1__thold__exit = _ctx__compact__a1__thold__exit;
exports._ctx__idx__sort = _ctx__idx__sort;
exports._ctx__idx__sort__a1__sort__idx = _ctx__idx__sort__a1__sort__idx;
exports._difference = _difference;
exports._difference__a1 = _difference__a1;
exports._eql__a1 = _eql__a1;
exports._eql__a1__fn = _eql__a1__fn;
exports._every = _every;
exports._filter = _filter;
exports._filter__idx = _filter__idx;
exports._find = _find;
exports._find__map = _find__map;
exports._first = _first;
exports._fn__compare = _fn__compare;
exports._fn__ctx__compact__a1__thold__entry = _fn__ctx__compact__a1__thold__entry;
exports._fn__ctx__compact__a1__thold__exit = _fn__ctx__compact__a1__thold__exit;
exports._fn__ctx__idx__sort = _fn__ctx__idx__sort;
exports._fn__every = _fn__every;
exports._fn__filter = _fn__filter;
exports._fn__filter__idx = _fn__filter__idx;
exports._fn__hash__item__idx = _fn__hash__item__idx;
exports._fn__hash__key = _fn__hash__key;
exports._fn__hash__key__idx = _fn__hash__key__idx;
exports._fn__hash__value = _fn__hash__value;
exports._fn__map = _fn__map;
exports._fn__map__andand = _fn__map__andand;
exports._fn__map__andand__fn = _fn__map__andand__fn;
exports._fn__reduce = _fn__reduce;
exports._fn__reject = _fn__reject;
exports._fn__reject__idx = _fn__reject__idx;
exports._fn__slice = _fn__slice;
exports._fn__slice__spread = _fn__slice__spread;
exports._fn__some = _fn__some;
exports._fn__sort = _fn__sort;
exports._fn__zipWith = _fn__zipWith;
exports._has__multiple = _has__multiple;
exports._has__multiple__a1 = _has__multiple__a1;
exports._hash__item__idx = _hash__item__idx;
exports._hash__key = _hash__key;
exports._hash__key__a1 = _hash__key__a1;
exports._hash__key__idx = _hash__key__idx;
exports._hash__value = _hash__value;
exports._hash__zip__key__value = _hash__zip__key__value;
exports._i__offset = _i__offset;
exports._idx = _idx;
exports._idx__circular = _idx__circular;
exports._idx__next = _idx__next;
exports._idx__prev = _idx__prev;
exports._intersection = _intersection;
exports._intersection__a1 = _intersection__a1;
exports._last = _last;
exports._last__a1 = _last__a1;
exports._length__a1 = _length__a1;
exports._map = _map;
exports._map__andand = _map__andand;
exports._map__andand_ = _map__andand_;
exports._next_idx = _next_idx;
exports._present__a1 = _present__a1;
exports._prev_idx = _prev_idx;
exports._reduce = _reduce;
exports._reject = _reject;
exports._reject__idx = _reject__idx;
exports._slice = _slice;
exports._slice__spread = _slice__spread;
exports._some = _some;
exports._sort = _sort;
exports._sort__key = _sort__key;
exports._sort__key__a1 = _sort__key__a1;
exports._spread = _spread;
exports._union = _union;
exports._union__a1 = _union__a1;
exports._uniq = _uniq;
exports._uniq__a1 = _uniq__a1;
exports._zipWith = _zipWith;
exports.compact = compact;
exports.compact__a1 = compact__a1;
exports.compare__asc = compare__asc;
exports.compare__desc = compare__desc;
exports.concat__a1 = concat__a1;
exports.concat__default__a1 = concat__default__a1;
exports.concat__truthy = concat__truthy;
exports.each = each;
exports.every = every;
exports.every__a1 = every__a1;
exports.filter = filter;
exports.filter__idx = filter__idx;
exports.find = find;
exports.find__map = find__map;
exports.flatten = flatten;
exports.flatten__a1 = flatten__a1;
exports.fn__compare__asc = fn__compare__asc;
exports.fn__compare__desc = fn__compare__desc;
exports.idx__random = idx__random;
exports.indexOf = indexOf;
exports.insert = insert;
exports.map = map;
exports.map__a1__idx__in__a1 = map__a1__idx__in__a1;
exports.map__andand = map__andand;
exports.map__andand_ = map__andand_;
exports.map__andand__fn = map__andand__fn;
exports.map__andand__or = map__andand__or;
exports.map__inverse = map__inverse;
exports.push = push;
exports.rank = rank;
exports.rank__a1 = rank__a1;
exports.rank__binarySort = rank__binarySort;
exports.rank__binarySort__a1 = rank__binarySort__a1;
exports.reduce = reduce;
exports.reject = reject;
exports.reject__idx = reject__idx;
exports.remove = remove;
exports.remove__a1 = remove__a1;
exports.remove__idx = remove__idx;
exports.remove__index = remove__index;
exports.reverse = reverse;
exports.slice = slice;
exports.slice__i__offset = slice__i__offset;
exports.some = some;
exports.some__a1 = some__a1;
exports.sort = sort;
exports.sort__name = sort__name;
exports.sort__name__a1 = sort__name__a1;
exports.splice = splice;
exports.splice__selector = splice__selector;
exports.splice__selector__a1 = splice__selector__a1;
