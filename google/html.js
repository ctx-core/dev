 ...
 * @returns {string} html
 */
export function $script__google__analytics(ctx, ...opts$$) {
...
export function $script__head__gtm(ctx, ...opts$$) {
  ...
  return `
<script type="text/javascript">window.dataLayer = ${JSON.stringify(dataLayer)};</script>
<!-- Google Tag Manager -->
 ...
 * @returns {string} html
 */
export function $script__body__gtm(ctx, ...opts$$) {
