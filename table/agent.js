...
export function agent__row$sources(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__row$sources`);
  return ensure__agent(ctx, {
    key: "agent__row$sources",
    scope: ["row$sources"]
  }, ...agent$ctx$$);
}
export function agent__ctx_rows(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__ctx_rows`);
  let agent__ctx_rows;
  ...
  function init(agent) {
    log(`${logPrefix}|agent__ctx_rows|init`);
    agent__ctx_rows = agent;
    ctx.agent__row$sources.on("change", refresh);
    refresh();
  }
  function refresh() {
    log(`${logPrefix}|agent__ctx_rows|refresh`);
...
export function agent__columns(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__columns`);
  let agent__columns;
  agent__row$sources(ctx);
  return ensure__agent(ctx, {
    key: "agent__columns",
  ...
  function init(agent) {
    log(`${logPrefix}|agent__columns|init`);
    agent__columns = agent;
    ctx.agent__row$sources.on("change", refresh);
    refresh();
  }
  function refresh() {
    log(`${logPrefix}|agent__columns|refresh`);
    change__agents(ctx, {}, () => {
...
export function agent__ctx_row_id(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__ctx_row_id`);
  return ensure__agent(ctx, {
    key: "agent__ctx_row_id",
    scope: ["ctx_row_id"]
  }, ...agent$ctx$$);
}
export function agent__ctx_rows$filter(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__ctx_rows$filter`);
...
export function agent__ctx_rows$filter$highlight(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__ctx_rows$filter$highlight`);
  ...
  function assign__ctx_rows$filter$highlight$() {
    log(`${logPrefix}|agent__ctx_rows$filter$highlight|assign__ctx_rows$filter$highlight$`);
...
export function agent__ctx_row(ctx, ...agent$ctx$$) {
  log(`${logPrefix}|agent__ctx_row`);
  let agent__ctx_row;
  agent__ctx_row_id(ctx);
  agent__ctx_rows(ctx);
  return ensure__agent(ctx, {
  ...
  function assign__ctx_row$(ctx) {
    log(`${logPrefix}|agent__ctx_row|assign__ctx_row$`);
    const ctx_rows = ctx.ctx_rows
